...
- **Prayer for the Fortieth Day**: See [liturgy/prayer-fortieth-day.md](liturgy/prayer-fortieth-day.md) for a dedicated prayer for the fortieth day after death — the most significant periodic commemoration in Catholic tradition — with traditional Latin prayers (Requiem Aeternam, De Profundis, In Paradisum) and a prayer of commendation, all with the canonical placeholder N. for general public use.
