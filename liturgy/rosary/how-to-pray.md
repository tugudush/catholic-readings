...
```mermaid
graph TD
    Crucifix[1. Crucifix: Sign of the Cross & Apostles' Creed] --> FirstLarge[2. First Large Bead: Our Father]
    FirstLarge --> ThreeSmall[3. Three Small Beads: Hail Mary ×3]
    ThreeSmall --> Space1[4. Space/Chain: Glory Be]
    Space1 --> Center[5. Centerpiece: First Mystery stated & Our Father]

    subgraph The Five Decades Loop
        Center --> Decade1[6. 10 Small Beads: Hail Mary ×10]
        Decade1 --> EndDecade1[7. Space: Glory Be & Fatima Prayer]
        EndDecade1 --> LargeBead1[8. Large Bead: Our Father & Next Mystery]
        LargeBead1 --> Decade2[9. 10 Small Beads: Hail Mary ×10]
        Decade2 --> EndDecade2[10. Space: Glory Be & Fatima Prayer]
        EndDecade2 --> LargeBead2[11. Large Bead: Our Father & Next Mystery]
        LargeBead2 --> Decade3[12. 10 Small Beads: Hail Mary ×10]
        Decade3 --> EndDecade3[13. Space: Glory Be & Fatima Prayer]
        EndDecade3 --> LargeBead3[14. Large Bead: Our Father & Next Mystery]
        LargeBead3 --> Decade4[15. 10 Small Beads: Hail Mary ×10]
        Decade4 --> EndDecade4[16. Space: Glory Be & Fatima Prayer]
        EndDecade4 --> LargeBead4[17. Large Bead: Our Father & Next Mystery]
        LargeBead4 --> Decade5[18. 10 Small Beads: Hail Mary ×10]
        Decade5 --> EndDecade5[19. Space: Glory Be & Fatima Prayer]
    end

    EndDecade5 --> Conclusion[20. Centerpiece: Hail, Holy Queen & Concluding Prayer]
```
