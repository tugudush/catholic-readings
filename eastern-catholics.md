...
graph TD
    ...
    Catholic[Catholic Church] --> Latin[Latin Church]
    Catholic --> Eastern[Eastern Catholic Churches]

    Eastern --> Alex[Alexandrian Tradition]
    Eastern --> Anti[Antiochene Tradition]
    Eastern --> Arm[Armenian Tradition]
    Eastern --> Chal[Chaldean Tradition]
    Eastern --> Const[Constantinopolitan / Byzantine Tradition]

    Alex --> Coptic[Coptic Catholic Church]
    Alex --> Eth[Ethiopian Catholic Church]
    Alex --> Eri[Eritrean Catholic Church]

    Anti --> Mar[Maronite Catholic Church]
    Anti --> Syr[Syrian Catholic Church]
    Anti --> SyroM[Syro-Malankara Catholic Church]

    Arm --> ArmC[Armenian Catholic Church]

    Chal --> ChalC[Chaldean Catholic Church]
    Chal --> SyroMal[Syro-Malabar Catholic Church]

    Const --> Mel[Melkite Greek Catholic]
    Const --> Ukr[Ukrainian Greek Catholic]
    Const --> Rom[Romanian Greek Catholic]
    Const --> Rut[Ruthenian Catholic]
    Const --> Slov[Slovak Greek Catholic]
    Const --> Hun[Hungarian Greek Catholic]
    Const --> Italo[Italo-Albanian Catholic]
    Const --> OtherByz[Others: Belarusian, Russian, Albanian, Georgian, Greek, etc.]
```
