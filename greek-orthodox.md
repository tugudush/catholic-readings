...
graph TD
    ...
    classDef patriarch fill:#e1f5fe,stroke:#0288d1,stroke-width:2px;
    classDef autocephalous fill:#efebe9,stroke:#5d4037,stroke-width:2px;

    class Constantinople patriarch;
    class Alexandria patriarch;
    class Antioch patriarch;
    class Jerusalem patriarch;
    class Greece autocephalous;
    class Cyprus autocephalous;

    Orthodoxy[Eastern Orthodox Communion] --> GreekOrth[Greek-Speaking Tradition]

    GreekOrth --> Constantinople["Ecumenical Patriarchate of Constantinople<br/>(Primacy of Honor - Istanbul, Turkey)"]
    GreekOrth --> Alexandria["Greek Orthodox Patriarchate of Alexandria<br/>(All Africa - Alexandria, Egypt)"]
    GreekOrth --> Antioch["Greek Orthodox Patriarchate of Antioch<br/>(Middle East - Damascus, Syria)"]
    GreekOrth --> Jerusalem["Greek Orthodox Patriarchate of Jerusalem<br/>(Holy Land - Jerusalem)"]
    GreekOrth --> Greece["Church of Greece<br/>(Established Autocephaly - Athens, Greece)"]
    GreekOrth --> Cyprus["Church of Cyprus<br/>(Ancient Autocephaly - Nicosia, Cyprus)"]

    Constantinople --> GOArch["Greek Orthodox Archdiocese of America<br/>(Diaspora Jurisdiction)"]
    Constantinople --> MountAthos["Monastic Republic of Mount Athos<br/>(Semi-Autonomous Monastic State)"]
```
